...
var App = function (_React$Component) {
    ...
    _createClass(App, [{
        ...
        value: function render() {
            return _react2.default.createElement(_Tabs2.default, null);
        }
    }]);
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'ul',
                    { className: 'col nav nav-pills' },
                    _react2.default.createElement(
                        _Button2.default,
                        { index: 0, active: this.state.activeTabIndex, onTab: this.handleTab },
                        'Active'
                    ),
                    _react2.default.createElement(
                        _Button2.default,
                        { index: 1, active: this.state.activeTabIndex, onTab: this.handleTab },
                        'Link'
                    ),
                    _react2.default.createElement(
                        _Button2.default,
                        { index: 2, active: this.state.activeTabIndex, onTab: this.handleTab },
                        'Link'
                    ),
                    _react2.default.createElement(
                        _Button2.default,
                        { index: 3, active: this.state.activeTabIndex, onTab: this.handleTab },
                        'Disabled'
                    )
                ),
                _react2.default.createElement(_Tab2.default, { tabIndex: this.state.activeTabIndex })
            );
        }
    }]);
...
var Button = function (_React$Component) {
    ...
    _createClass(Button, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                'li',
                { 'data-index': this.props.index, onClick: this.handleClick, className: 'nav-item' },
                _react2.default.createElement(
                    'a',
                    { className: 'nav-link' + (this.props.active == this.props.index ? ' active' : ''), href: '#' },
                    this.props.children
                )
            );
        }
